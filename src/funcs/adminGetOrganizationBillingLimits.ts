 ...
 */
export function adminGetOrganizationBillingLimits(
  client: SpeakeasyAdminCore,
  request: operations.GetOrganizationBillingLimitsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetOrganizationBillingLimitsResponse,
    | errors.ErrorT
    | APIError
    | SDKValidationError
    | UnexpectedClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOrganizationBillingLimitsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      "2XX",
      operations.GetOrganizationBillingLimitsResponse$inboundSchema,
    ),
