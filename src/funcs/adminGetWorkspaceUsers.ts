 ...
 * Returns all users for a particular workspace by workspace ID.
 */
export function adminGetWorkspaceUsers(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWorkspaceUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin/workspaces/{workspaceID}/users")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json("2XX", z.array(components.User$inboundSchema)),
