...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SearchEventsRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    ...
    "generate_target": payload.generate_target,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.CliEvent$inboundSchema)),
