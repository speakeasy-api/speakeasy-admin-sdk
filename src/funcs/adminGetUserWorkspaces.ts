...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUserWorkspacesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/admin/users/{userID}/workspaces")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json("2XX", z.array(components.Workspace$inboundSchema)),
